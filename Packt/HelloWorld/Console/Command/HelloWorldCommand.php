...
class HelloWorldCommand extends	Command{
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
        $output->writeln('<error>'.'Writenln surrounded by error tag'.'</error>');
        $output->writeln('<comment>'.'Writenln surrounded by info tag'.'</comment>');
        $output->writeln('<question>'.'Writenln surrounded by question tag'.'</question>');
